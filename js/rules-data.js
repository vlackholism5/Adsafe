// AdSafe 검수 룰 데이터 (택소노미 기반)
// 각 룰: riskCode, level1, level2, level3, riskLevel, keywords, regex(선택), explanation, suggestion
// 이벤트 자동 체크 로직은 inspection-engine.js에서 처리
window.ADU_RULES = [
    // 1. 과장·최상급 계열
